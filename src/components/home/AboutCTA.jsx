...
const AboutCTA = () => {
  return (
    <section className="relative w-full p-8 col-start-1 col-end-13 min-h-[560px] bg-aboutCTAMob bg-no-repeat bg-cover flex flex-col justify-center items-start gap-6 mdTab:col-start-2 mdTab:col-end-12 tab:p-14 tab:bg-aboutCTATab">
