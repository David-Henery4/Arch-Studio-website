...
const Footer = () => {
  return (
    <footer className="w-full col-start-1 col-end-13 grid grid-rows-footerMob tab:grid-cols-footerTab tab:grid-rows-[auto] lap:col-start-2 lap:col-end-12">
      ...
      <div className="w-full row-start-1 row-end-3 col-start-1 col-end-2 flex flex-col justify-center items-center gap-8 pb-12 tab:flex-row tab:justify-between tab:p-0 tab:col-start-1 tab:col-end-3 tab:row-start-1 tab:row-end-2 lap:gap-[85px]">
        <Link
          aria-label="Logo Link in the Footer that leads back to the home page"
          to="/"
        >
